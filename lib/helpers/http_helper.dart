...
import 'package:e_commerce_test/helpers/storage_helper.dart';
...
class HttpHelper {
  ...
  static Future<Map<String, String>> _getHeaders({String? contentType}) async {
    final storageToken = await StorageHelper.getString("token");
  ...
  static Future<Dio> _getInstance(
    ...
    // _client!.interceptors.add(InterceptorsWrapper(onError: (e, handler) async {
    //   // if (e.response?.statusCode == 401) {
    //   //   log('UNAUTHORIZED');
    //   //   // injector.get<AuthBloc>().add(const UnAuthorizedEvent());
    //   //   // return err;
    //   // } else {
